...
namespace NominaMAD
{
    public partial class P_Menu2 : Form
    {
        public P_Menu2()
        {
            InitializeComponent();
        ...
        private void btn_GestionEmpleados_MENU2_Click(object sender, EventArgs e)
        {
        ...
        private void P_Menu2_Load(object sender, EventArgs e)
        {

            text_NombreUsuario_MENU2.Text= P_Inicio.NombUsuario;
        }
        ...
        private void btn_ReciboEmpleado_MENU2_Click(object sender, EventArgs e)
        {
            // Crear una instancia del nuevo formulario
        ...
        private void btn_Salir_MENU2_Click(object sender, EventArgs e)
        {
        ...
        private void btn_GestionDepar_MENU2_Click(object sender, EventArgs e)
        {
            // Crear una instancia del nuevo formulario
        ...
        private void btn_GestionPuestos_MENU2_Click(object sender, EventArgs e)
        {
            // Crear una instancia del nuevo formulario
